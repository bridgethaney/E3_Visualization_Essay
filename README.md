...
When the clients sends a request to the site, the destination server responds by providing the map with all its features and data.
...
[No Author] <em>API Documentation - Earthquake Catalog.</em> (n.d.). Retrieved March 12, 2021, from https://earthquake.usgs.gov/fdsnws/event/1/
