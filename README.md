...
It seems as though, drawing together these key points, along with the previous mention of the more visual and systematic aspects above, the map's portrayal of the data demonstrates a strong need for action. The main function of showcasing the pervasiveness of natural disasters throughout different periods of time can raise concern from those directly or indirectly affected.
